...
if (fs.existsSync(path)) {
    ...
    const exists = data.projects.some(p => p.id === 'proj_demo_megaproject');
    if (!exists) {
        const megaproject = {
            "id": "proj_demo_megaproject",
            "user_id": 1,
            "name": "Proyecto_Megaconstruccion_3_Anos.xlsx",
            "start": "2026-07-01",
            "status": "active",
            "excludeWeekends": true,
            "tasks": [
                { "id": 1, "name": "FASE 1: PLANIFICACIÓN Y FACTIBILIDAD", "start": "2026-07-01", "duration": 120, "dependencies": "", "progress": 95, "owner": "Comité", "risk": "Low", "indent": 0 },
                { "id": 2, "name": "Estudios Ambientales e Ingeniería Básica", "start": "2026-07-01", "duration": 80, "dependencies": "1FS-20", "progress": 85, "owner": "Consultor", "risk": "Medium", "indent": 1 },
                ...
                { "id": 5, "name": "FASE 2: CONSTRUCCIÓN Y OBRAS CIVILES", "start": "2026-07-01", "duration": 380, "dependencies": "4FS", "progress": 10, "owner": "Ingeniero Civil", "risk": "Medium", "indent": 0 },
                ...
                { "id": 9, "name": "FASE 3: INSTALACIONES, ACABADOS Y PRUEBAS", "start": "2026-07-01", "duration": 240, "dependencies": "8FS", "progress": 0, "owner": "Supervisor", "risk": "Low", "indent": 0 },
        ...
        data.projects.push(megaproject);
        fs.writeFileSync(path, JSON.stringify(data, null, 2), 'utf8');
        console.log("Mega-proyecto insertado con éxito en la base de datos.");
    } else {
        console.log("El mega-proyecto ya existe en la base de datos.");
    }
} else {
